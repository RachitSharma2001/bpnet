...
from data_oncpu import BatchNormDataset
...
@gin.configurable
class AddedChannels_StrandedProfile(BatchNormDataset):
    ...
    def __init__(self, ds,
        ...
        # Sanity Check
        print("Files: ")
        for file in additional_bw_channels:
            print(file)
        print("-------------------------------------------")
    ...
    def __getitem__(self, idx):
        ...
        if self.added_channel_extractors is not None:
            ...
            if(self.exclude_dna is False):
                ...
                #print("We are not excluding the dna: ", self.exclude_dna)
            else:
                sequence = np.array(added_rows)
                #print("We are excluding DNA")
